...
var Ed3d = {
  ...
  'init' : function(options) {
    ...
    if(typeof isMinified !== 'undefined') {
      Ed3d.launchMap();
      Loader.stop();      
    }else{
      $.when(
  ...
  'rebuild' : function(options) {
    ...
    // Reload from JSon
    if(Ed3d.jsonPath != null) Ed3d.loadDatasFromFile();
    else if(Ed3d.jsonContainer != null) Ed3d.loadDatasFromContainer();
    else if(Ed3d.json != null)
    {
      console.log(Ed3d.json)
      Ed3d.loadDatas(Ed3d.json);
  ...
  'destroy' : function() {
    ...
    Loader.update('Removing System & HUD filters');
  ...
  'launchMap' : function() {
    ...
    Ed3d.Galaxy.addGalaxyCenter();

    // Load systems
    Loader.update('Loading JSON file');
    if(Ed3d.jsonPath != null)
    {
       Ed3d.loadDatasFromFile();
    }
    else if(Ed3d.jsonContainer != null)
    {
    ...
    if(!Ed3d.startAnim) {
      Ed3d.grid1XL.hide();
      Ed3d.Galaxy.milkyway2D.visible = false;
    }
  ...
  //  --------------------------------- 
  //  Load Textures - Init Three.js scene textures
  //  --------------------------------- 
  'loadTextures' : function() {
    ...
    //-- Load textures
    Ed3d.textures.flare_white = texloader.load(Ed3d.basePath + "textures/lensflare/flare2.png");
    Ed3d.textures.flare_yellow = texloader.load(Ed3d.basePath + Ed3d.starSprite);
    Ed3d.textures.flare_center = texloader.load(Ed3d.basePath + "textures/lensflare/flare3.png");
  ...
  'addCustomMaterial' : function (id, color) {
    ...
    Ed3d.colors[id] = color;

  },

  //  --------------------------------- 
  //  Init Scene - Init Three.js scene
  //  ---------------------------------
  'initScene' : function() {
  ...
  //  --------------------------------- 
  //  Show Scene - Show the scene when fully loaded
  //  ---------------------------------
  'showScene' : function() {
      scene.visible = true;
  },
...
var Loader = {
  ...
  //-----------------------------
  //  Update - Refresh infos for current loading step
  //-----------------------------
